        ...
        <form action="/" method="post">
            <div class="form-group">
                <div class="row g-3 align-items-center">
                    <div class="col-auto">
                    <label for="brandName" class="form-label">Search Brand</label>
                    </div>
                    <div class="col-auto">
                        <input type="text" class="form-control" id="brandName" name="brandName" placeholder="Brand Name"/>
                    </div>
                    <div class="col-auto">
                        <button aria-label="Search Cloud Kitchen Button" class="btn btn-primary" type="submit">
                    ...
                    <div class="col-auto">
                        <button aria-label="Edit Brand" class="btn btn-primary" type="button">
